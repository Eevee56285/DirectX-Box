...
The dashboard is the heart of DirectX-Box, built around the [Theseus](https://github.com/MrMilenko/Theseus "Theseus")
 ...
 This may not be needed becuase i have just figured out i can dumb a Original xbox with the os on it to a hard drive image and xemu is the only thing needed here
